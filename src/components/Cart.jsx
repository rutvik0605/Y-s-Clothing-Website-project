...
function Cart() {
  ...
  const handleOrder = async () => {
    if (!form.name || !form.phone || !form.address) {
      alert("Please select a size and fill all fields!")
      return
    }
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span onClick={() => setCartOpen(false)} style={{ fontSize: "24px", cursor: "pointer" }}>✕</span>
        </div>
          ...
          {ordered ? (
            ...
            <>
                ...
                <div key={i} style={{
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "10px", marginTop: "8px" }}>
                      <button onClick={() => updateQty(item.name, item.size, item.qty - 1)} style={qtyBtn}>−</button>
              ...
              <div style={{ marginTop: "8px" }}>
                <p style={{ fontWeight: 700, fontSize: "14px", color: "#17203D", marginBottom: "12px" }}>
